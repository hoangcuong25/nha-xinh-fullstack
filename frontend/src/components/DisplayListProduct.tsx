                ...
                {products.slice(0, 5).map((product: any, index) => (
                    <div className='group relative mt-5' key={index}>
                        <div className='flex flex-col items-center justify-start mt-5 mx-3.5 lg:mx-7 rounded-md cursor-pointer transition-all duration-300 group-hover:-translate-y-5'>
                            ...
                            <p className='w-full text-start font-semibold mt-2 text-[13px] sm:text-base'>{product.name}</p>
                        ...
                        <div className='flex flex-col sm:flex-row items-center justify-between px-1 lg:px-3.5 mx-3 mt-2 transition-all duration-300 group-hover:-translate-y-5'>
                            <Button
